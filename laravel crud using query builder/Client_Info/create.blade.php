...
@section('content')
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Corporate Client</li>
                ...
                <div id="panel-3" class="panel">
                    ...
                    <div class="panel-container show">
                        <div class="panel-content">
                            ...
                            <form id="commission_form" action="{{route('client.info.client_store')}}" method="post"
                ...
                submitHandler: function(form) {
                    ...
                    cuteAlert({
                        ...
                        if (e == ("confirm")) {
                            $.ajax({
                                type: 'POST',
                                url: '{{ route('client.info.client_store') }}',
                                data: $(form).serialize(),
                                beforeSend: function() {
                                    loaderStart();
                                },
