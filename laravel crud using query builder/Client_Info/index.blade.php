...
@section('content')
    ...
    <main id="js-page-content" role="main" class="page-content">
        <ol class="breadcrumb page-breadcrumb">
            ...
            <li class="breadcrumb-item">Corporate Client Informatioon</li>
        ...
        <div class="subheader">
            <h1 class="subheader-title">
                ...
                <span style="float:right">
                    <a href="{{route('client.info.client_create')}}" class="btn btn-sm btn-primary">
                                ...
                                <tbody>
                                    @foreach ($client_ifo as $data)
                                        <tr>
                                            ...
                                            <td>{{$data->address}}</td>
                                            <td><a href="{{ route('client.info.client_edit',Crypt::encrypt($data->id )) }}"
