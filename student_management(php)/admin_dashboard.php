...
<body>
	...
	<div id="right_side"><br><br>
		<div id="demo">
			...
			<!-- #Code for Add teacher details---Start-->
			<?php
					...
					<center>
						<table style="border-collapse: collapse;border: 1px solid black;">
							<tr>
								...
								<td id="td">
									<a href="#">View</a>
									<a href="edit_teacher.php?id=<?php echo $row['t_id']; ?>">Edit</a>
									<a href="delete_teacher.php?t_id=<?php echo $row['t_id']; ?>" onclick="return confirm('Are you sure you want to delete this item?');">Delete</a>
								</td>
							</tr>
						</table>
					</center>
